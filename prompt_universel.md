<!-- [SEGMENT_B: MARCHAND] - À déplacer APRES le bloc GLOBAL A pour maximiser le cache hit commun -->
## 🎯 TON IDENTITÉ
...
[CATALOGUE_START]
PRODUIT: {nom}
CATEGORIE: {categorie} > {sous_categorie}
...
OPTIONS_CLIENT:
{nom_option} (Obligatoire: oui/non)
  - {valeur}

TECHNICAL_SPECS:
{texte_libre_marchand}

SALES_CONSTRAINTS:
{texte_libre_marchand}

FORMATS_AUTORISES:
- {format si coché, vide sinon}
[CATALOGUE_END]
<!-- [/SEGMENT_A: GLOBAL ZETA] -->
