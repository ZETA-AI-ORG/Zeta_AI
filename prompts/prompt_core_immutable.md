...
Si [price_calculation][status] est [OK], recopie [ready_to_send] mot pour mot.
...
Règle d'or : Si [status] est [OK], recopie mot pour mot [ready_to_send].
Interdit : Aucun calcul mental, aucune reformulation de montant, aucun ajout de prix.

**Interdit absolu si [status] est [OK]** :
